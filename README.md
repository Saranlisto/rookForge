...
- `search`: fixed-depth alpha-beta search with terminal handling and quiescence
...
- Fixed-depth alpha-beta search using legal moves and material evaluation
...
Checkmate score = +/-100000 adjusted by ply
```
...
5. Add deeper handcrafted evaluation terms.
